...
17. Streak doesnot update instantly on ui takes app restart to show up
18. in the goals page draggin to update the priority doesnot work no dragging holding it gives delete option should be right side hold drag and other place delete.
19. no visual clue of priority in goals page
