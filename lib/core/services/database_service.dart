...
final habitMetricsRepositoryProvider = Provider<HabitMetricsRepository>((ref) {
  final isar = ref.watch(isarProvider);
  return HabitMetricsRepository(isar);
});

final dailyActivityLogRepositoryProvider = Provider<DailyActivityLogRepository>((ref) {
  final isar = ref.watch(isarProvider);
  return DailyActivityLogRepository(isar);
});
