...
extension MilestoneQueryWhereSort
  ...
  QueryBuilder<Milestone, Milestone, QAfterWhere> anyIsCompleted() {
    return QueryBuilder.apply(this, (query) {
...
extension MilestoneQueryWhere
  ...
  QueryBuilder<Milestone, Milestone, QAfterWhereClause> isCompletedEqualTo(
      bool isCompleted) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Milestone, Milestone, QAfterWhereClause> isCompletedNotEqualTo(
      bool isCompleted) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension MilestoneQueryFilter
  ...
  QueryBuilder<Milestone, Milestone, QAfterFilterCondition> orderIndexEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Milestone, Milestone, QAfterFilterCondition> orderIndexLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Milestone, Milestone, QAfterFilterCondition> orderIndexBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MilestoneQuerySortBy on QueryBuilder<Milestone, Milestone, QSortBy> {
  ...
  QueryBuilder<Milestone, Milestone, QAfterSortBy> sortByOrderIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'orderIndex', Sort.asc);
    });
  }

  QueryBuilder<Milestone, Milestone, QAfterSortBy> sortByOrderIndexDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MilestoneQuerySortThenBy
  ...
  QueryBuilder<Milestone, Milestone, QAfterSortBy> thenByOrderIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'orderIndex', Sort.asc);
    });
  }

  QueryBuilder<Milestone, Milestone, QAfterSortBy> thenByOrderIndexDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'orderIndex', Sort.desc);
    });
  }
...
extension MilestoneQueryWhereDistinct
  ...
  QueryBuilder<Milestone, Milestone, QDistinct> distinctByOrderIndex() {
    return QueryBuilder.apply(this, (query) {
...
extension MilestoneQueryProperty
  ...
  QueryBuilder<Milestone, int, QQueryOperations> orderIndexProperty() {
    return QueryBuilder.apply(this, (query) {
